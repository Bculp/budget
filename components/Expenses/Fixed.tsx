    ...
    <div>
      ...
      <div className={styles.container}>
        ...
        <Generator
          ...
          fields={[
            ...
            },
            {
              label: 'Cell Phone',
              onChange: (value: number) =>
                mergeExpenseUpdate('fixed', 'cellPhone', 'actual', value),
            ...
            },
            {
              ...
              onChange: (value: number) =>
                mergeExpenseUpdate('fixed', 'allTrails', 'actual', value),
        ...
        <Generator
          ...
          fields={[
            ...
            },
            {
              label: 'Internet',
              onChange: (value: number) =>
                mergeExpenseUpdate('fixed', 'internet', 'budgeted', value),
            ...
            },
            {
              label: 'Spotify',
              onChange: (value: number) =>
                mergeExpenseUpdate('fixed', 'spotify', 'budgeted', value),
        ...
        <Generator
          ...
          total={fixed.totalFixedDifference}
        />
      </div>
    </div>
  );
